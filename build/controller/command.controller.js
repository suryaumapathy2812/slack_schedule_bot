...
var commandController = express_1.default.Router();
exports.commandController = commandController;
commandController.post("/dinner_message", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var commandService, messageResponse, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, commandService.dinnerMessage(req)];
            case 1:
...
commandController.post("/create_poll", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var commandService, model, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                console.log(req.body);
                commandService = new command_service_1.CommandService();
                return [4 /*yield*/, commandService.createPollModel(req)];
            case 1:
                model = _a.sent();
                console.log(model);
